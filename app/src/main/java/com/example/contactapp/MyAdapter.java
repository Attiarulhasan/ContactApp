...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    private ArrayList email_id;
    private ArrayList number_id;

    public MyAdapter(Context context, ArrayList name_id, ArrayList email_id, ArrayList number_id) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView name_id, email_id, number_id;
